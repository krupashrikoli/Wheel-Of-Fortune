...
export function WheelValueCard({ value, className = "" }: WheelValueCardProps) {
  return (
    ...
    >
      <p className="text-lg font-extrabold tracking-[0.15em] text-game-orange uppercase sm:text-xl">
        Wheel Value
      </p>
      <p className="font-display text-[clamp(2rem,4vh,3.25rem)] font-extrabold text-primary-blue">
