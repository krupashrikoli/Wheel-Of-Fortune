...
export function CallOutButton({ onClick, disabled }: CallOutButtonProps) {
  return (
    ...
    >
      ...
      <span className="relative block text-xl font-extrabold tracking-[0.12em] uppercase sm:text-2xl">
        Call Out Answer
      </span>
      <span className="relative mt-0.5 block text-lg font-bold opacity-95 sm:text-xl">
        +50,000 / −50,000
      </span>
    </motion.button>
  );
